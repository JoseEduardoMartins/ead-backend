...
router.post(`${api.path}/questionnaires`, validate(['activity', 'description', 'amountQuestion'], validators), controller.createQuiz);

router.put(`${api.path}/questionnaires/:id`, validate(['id', 'activity', 'description', 'amountQuestion'], validators), controller.updateQuiz);
